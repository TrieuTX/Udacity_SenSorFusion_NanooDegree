...
void simpleHighway(pcl::visualization::PCLVisualizer::Ptr &viewer)
{
    ...
    renderPointCloud(viewer, segmentCloud.first, "ostCloud", Color(0, 1, 0));
    ...
    int clusterId = 0;
    std::vector<Color> colors = {Color(0.5, 0.5, 0), Color(0, 1, 0), Color(0, 0, 1)};
...
{
    // ------------------------------------------------------------------
    // -----Open 3D viewer and display City Block with single PCD   -----
    // ------------------------------------------------------------------
...
{
    // ------------------------------------------------------------------
    // -----Open 3D viewer and display City Block with Stream PCD   -----
    // ------------------------------------------------------------------
    pcl::PointCloud<pcl::PointXYZI>::Ptr filterCloud =
