...
% remains contant
% provide the initial range and velocity of the target. 
% Range cannot exceed the max value of 200m and 
...
Band_width = Speed_of_Light/(2*Radar_Range_Resolution);
T_chirp = 5.5 * 2 * Radar_Max_Range / Speed_of_Light;
Slope = Band_width / T_chirp;
