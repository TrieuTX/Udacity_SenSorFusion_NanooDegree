...
struct Car
{
    ...
    void render(pcl::visualization::PCLVisualizer::Ptr &viewer)
    {
        ...
        viewer->addCube(Eigen::Vector3f(position.x, position.y, dimensions.z * 1 / 3), orientation, dimensions.x,
        ...
        // render top of car
        viewer->addCube(Eigen::Vector3f(position.x, position.y, dimensions.z * 5 / 6), orientation, dimensions.x / 2,
